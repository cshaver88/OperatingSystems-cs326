...
extern int sys_my_getpid(void);
extern int sys_halt(void);
extern int sys_palloc(void);
extern int sys_mmap_alloc(void);
extern int sys_mmap_attach(void);
extern int sys_mmap_detach(void);
extern int sys_sema_init(void);
extern int sys_sema_down(void);
extern int sys_sema_up(void);
...
[SYS_my_getpid] sys_my_getpid,
[SYS_halt]	sys_halt,
[SYS_palloc] sys_palloc,
[SYS_mmap_alloc] sys_mmap_alloc,
[SYS_mmap_attach] sys_mmap_attach,
[SYS_mmap_detach] sys_mmap_detach,
